...
\end{itemize}
			...
			Modul \texttt{settings.py} figuruje jen jako konfigurační soubor, umožňující změnit hlavní nastavení celého programu. Nejdůležitějším nastavením je \texttt{sideLength} určující počet polí v mřížce, dále lze nastavit rozlišení a barvy polí.
  			...
  			\begin{figure}[h]
  			\includegraphics[width=\textwidth]{diagram1}\caption{Diagram modulů a tříd}\label{app_diagram}\end{figure}
...
\begin{minipage}[t]{0.48\textwidth}
  			...
  			\includegraphics[width=\textwidth]{a*_maze}\caption{Dokončená vizualizace A* v bludišti.}\label{a*_maze}
			
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\textwidth]{greedy_maze}\caption{Dokončená vizualizace hladového uspořádaného vyhledávání v bludišti.}\label{greedy_maze}
    \end{minipage}
    \end{minipage}\vspace{1ex}
\end{figure}
...
\begin{minipage}[c]{0.48\textwidth}
  			...
  			\includegraphics[width=\textwidth]{dfs_maze}\caption{Dokončená vizualizace DFS v bludišti.}\label{DFS_maze}
			
    \end{minipage}\hfill
    \begin{minipage}[c]{0.48\textwidth}
\includegraphics[width=\textwidth]{bfs_maze}\caption{Dokončená vizualizace BFS v bludišti.}\label{BFS_maze}
    \end{minipage}
    \end{minipage}\vspace{1ex}
\end{figure}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\textwidth]{Ibfs_user}\caption{Dokončená vizualizace BFS na stejném grafu.}\label{bfs_user}
    \end{minipage}
    \end{minipage}\vspace{1ex}
\end{figure}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \end{minipage}\hfill
    \begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=\textwidth]{bfs2_user}\caption{Dokončená vizualizace BFS na nakresleném grafu.}\label{bfs2_user}
    \end{minipage}
    \end{minipage}\vspace{1ex}
\end{figure}
